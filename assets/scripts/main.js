...
/* Logo institucional de la Gobernación del Estado Táchira, usado como
   respaldo (punto explícito del usuario) en cualquier ente que no tenga
   su propio logo cargado en logoImages. Queda vacío a propósito hasta
   que el equipo suministre el archivo real -- no se descarga ni se
   inventa ningún escudo institucional. */
const GOB_TACHIRA_LOGO_B64 = '';
